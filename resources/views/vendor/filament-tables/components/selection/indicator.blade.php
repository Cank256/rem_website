@php
    ...
    // Use number_format() instead of Number::format() to avoid requiring the intl PHP extension
    $formattedCount = number_format($allSelectableRecordsCount);
@endphp
...
>
    ...
    <div class="flex gap-x-3">
        ...
        <div class="flex gap-x-3">
            ...
            >
                {{ trans_choice('filament-tables::table.selection_indicator.actions.select_all.label', $allSelectableRecordsCount, ['count' => $formattedCount]) }}
            </x-filament::link>

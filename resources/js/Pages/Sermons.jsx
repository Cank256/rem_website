                ...
                {sermons.data && sermons.data.length > 0 ? (
                    <>
                        <div className="space-y-6">
                            ...
                            <div key={sermon.id} className="bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow overflow-hidden">
                                <div className="md:flex">
                                    {/* Sermon Thumbnail */}
                                    <div className="md:w-64 bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center p-8">
                                        {sermon.youtube_url && getYouTubeEmbedUrl(sermon.youtube_url) ? (
                                            <img 
                                                src={`https://img.youtube.com/vi/${getYouTubeEmbedUrl(sermon.youtube_url).split('/').pop()}/mqdefault.jpg`}
                                                alt={sermon.title}
